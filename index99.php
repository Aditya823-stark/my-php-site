    ...
    <section class="features-section py-5" style="background-color: #f8f9fa;">
        <div class="container">
            <div class="text-center mb-5">
                <h2 class="mb-3" style="color: #1e3a8a; font-weight: 700;">Why Choose Indian Railways?</h2>
                <p class="lead" style="color: #4b5563; font-size: 1.25rem;">Experience the best in rail travel with our premium services</p>
            </div>
            
            <div class="row">
                <div class="col-md-4 mb-4">
                    <div class="feature-card text-center p-4 h-100" style="background: white; border-radius: 10px; box-shadow: 0 5px 15px rgba(0,0,0,0.05); transition: transform 0.3s ease, box-shadow 0.3s ease;">
                        <div class="feature-icon mb-3" style="width: 70px; height: 70px; margin: 0 auto; background: #e3f2fd; border-radius: 50%; display: flex; align-items: center; justify-content: center;">
                            <i class="fas fa-train" style="font-size: 1.75rem; color: #1976d2;"></i>
                        </div>
                        <h4 style="color: #1e3a8a; margin-bottom: 15px;">Comfortable Travel</h4>
                        <p style="color: #4b5563; margin-bottom: 0;">Experience the most comfortable train journeys with modern amenities and spacious seating arrangements.</p>
                    </div>
                </div>
                
                <div class="col-md-4 mb-4">
                    <div class="feature-card text-center p-4 h-100" style="background: white; border-radius: 10px; box-shadow: 0 5px 15px rgba(0,0,0,0.05); transition: transform 0.3s ease, box-shadow 0.3s ease;">
                        <div class="feature-icon mb-3" style="width: 70px; height: 70px; margin: 0 auto; background: #e8f5e9; border-radius: 50%; display: flex; align-items: center; justify-content: center;">
                            <i class="fas fa-route" style="font-size: 1.75rem; color: #2e7d32;"></i>
                        </div>
                        <h4 style="color: #1e3a8a; margin-bottom: 15px;">Extensive Network</h4>
                        <p style="color: #4b5563; margin-bottom: 0;">Connect to over 7,000 stations across India with our vast railway network.</p>
                    </div>
                </div>
                
                <div class="col-md-4 mb-4">
                    <div class="feature-card text-center p-4 h-100" style="background: white; border-radius: 10px; box-shadow: 0 5px 15px rgba(0,0,0,0.05); transition: transform 0.3s ease, box-shadow 0.3s ease;">
                        <div class="feature-icon mb-3" style="width: 70px; height: 70px; margin: 0 auto; background: #fff3e0; border-radius: 50%; display: flex; align-items: center; justify-content: center;">
                            <i class="fas fa-utensils" style="font-size: 1.75rem; color: #e65100;"></i>
                        </div>
                        <h4 style="color: #1e3a8a; margin-bottom: 15px;">On-board Dining</h4>
                        <p style="color: #4b5563; margin-bottom: 0;">Enjoy delicious meals with our premium catering services during your journey.</p>
                    </div>
                </div>
            </div>
        </div>
